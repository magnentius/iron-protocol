...
| Running cold | A Frame that has not spent its 4th EP in a turn has no infrared signature and **cannot be locked on IR at all** — a hard block, not a check, since there is nothing to contest. Adaptive Skin upkeep is exempt, so buying stealth never exposes you |
