...
- [7. Optional Planetary Environment Rules](#7-optional-planetary-environment-rules)
  - [7.1 Visibility & Sensors](#71-visibility--sensors)
  - [7.2 Gravity & Locomotion](#72-gravity-locomotion)
  - [7.3 Atmospheric Composition](#73-atmospheric-composition)
...
- [9. Sample Frames](#9-sample-frames)
  ...
  - [9.3 IF-09 "Colossus"](#93-if-09-colossus-heavy-assault-frame)
...
- **Example 2 (Jump Jet Cliff-Jumping)**: An IF-01 "Specter" (Reactor 8, Capacitor 4, total 12 EP available) starts its activation at the base of a steep Level 2 cliff (Level 0 hex adjacent to a Level 2 hex).
...
## 7. Optional Planetary Environment Rules
For players seeking advanced simulation, these optional rules introduce environmental hazards, gravity differentials, and diverse atmospheres to the battlefield.

### 7.1 Visibility & Sensors
...
### 9.3 IF-09 "Colossus" (Heavy Assault Frame)
