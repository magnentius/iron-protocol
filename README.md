...
*   **100% Deterministic Combat (No "To-Hit" Rolls)**: *Iron Protocol* eliminates the frustration of missing a 95% shot. If you achieve a sensor lock on a target, your weapons automatically hit. The entire tactical puzzle revolves around manipulating line-of-sight, terrain cover, and Electronic Warfare (Adaptive Skin, ECM, Smoke) to secure your locks while blinding the enemy.
...
*   **Brutal Attrition & Critical Cascades**: Attacks damage specific hit locations (Head, Torso, Arms, Legs). Instead of just subtracting HP, penetrating hits permanently degrade Armor Damage Reduction (DR). A rain of light autocannon fire will literally sand down a heavy frame's armor over time, exposing the frame to cascading critical hits to catastrophic ammo explosions, severed limbs, and reactor core meltdowns.
*   **The Code of Honor**: Field legendary named pilots who swear ancient oaths before combat. You can gain massive mechanical advantages, but at a severe thematic cost: a pilot with the *Vow of Courage* is mechanically forbidden from ever walking backward, and a pilot with the *Vow of Respect* cannot fire on an enemy's rear arc. Break your vow, and your pilot is dishonored, suffering permanent penalties for the rest of the battle.
...
* 📱 **[Battle Tracker](docs/)**: A mobile web app that carries the bookkeeping for you — energy and capacitor charge, Flank Speed status, locational Armor DR, Ammo Dice, cooldowns, and the permanent critical-hit effects that are easy to lose track of. It includes a guided attack resolver that walks the Combat Phase sequence and shows its arithmetic, and two players on separate phones can share one live battle via a room code. See **[docs/README.md](docs/README.md)** to run or deploy it.
